...
def conv3x3(in_planes, out_planes, stride=1, groups=1, dilation=1):
    ...
    return nn.Conv2d(in_planes, out_planes, kernel_size=3, stride=stride, padding=dilation, has_bias=False, dilation=dilation,pad_mode='pad')


def conv1x1(in_planes, out_planes, stride=1):
    """1x1 convolution"""
    return nn.Conv2d(in_planes, out_planes, kernel_size=1, stride=stride, has_bias=False, pad_mode='same')
